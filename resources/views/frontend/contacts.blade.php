...
<body>
    ...
    <section id="two">
        <h1>{{$contact_s1->title}}</h1>
        <h1>{{$contact_s1->subtitle}}</h1>
    </section>
    <!-- preloader -->
                ...
                <div class="one-features">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="section-details">
                                ...
                                <a href="/bot" class="btn btn-learn-more">LEARN MORE <i class="ion-ios-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                         <a><img  src="assets/images/telegram.png" alt="Responsive image" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="two-features">
                    <div class="row">
                        <div class="container text-center">
                            <img src="assets/images/wa.png" alt="Responsive image" class="img-responsive">
                        </div>
                        <div class="col-md-8">
                            <div class="section-highlight">
                                 <h2>WHATSAPP</h2>
                            ...
                            <div class="section-details">
                                ...
                                <a href="/wa" class="btn btn-learn-more">LEARN MORE <i class="ion-ios-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
